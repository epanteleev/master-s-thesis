...
\newcommand{\size}[2]{{\fontsize{#1}{0}\selectfont#2}} % manage size of font
...
\titleformat{\section}{}{}{12.5mm}{\centering{\quad\MakeTextUppercase{#1}}\vspace{1em}} \titleformat{\subsection}[block]{\vspace{1em}}{}{12.5mm}{\thesubsection\quad#1\vspace{1em}}                             \titleformat{\subsubsection}[block]{\vspace{1em}\normalsize}{}{12.5mm}{\thesubsubsection\quad#1\vspace{1em}}
...
\renewcommand{\section}[2]{\anonsection{#1}}
